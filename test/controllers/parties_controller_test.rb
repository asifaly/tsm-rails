...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { account_id: @party.account_id, bic: @party.bic, city: @party.city, country_id: @party.country_id, name: @party.name } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { account_id: @party.account_id, bic: @party.bic, city: @party.city, country_id: @party.country_id, name: @party.name } }
