...
class BaseProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create base_product" do
    assert_difference('BaseProduct.count') do
      post base_products_url, params: { base_product: { description: @base_product.description } }
    end
  ...
  test "should update base_product" do
    patch base_product_url(@base_product), params: { base_product: { description: @base_product.description } }
